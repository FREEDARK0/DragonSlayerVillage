...
export const BLOCK_TYPE_TABLE: Record<BlockType, BlockTypeDef> = {
  ...
  [BlockType.GUARDIAN]: { type: BlockType.GUARDIAN, label: '卫士', color: 0xffddaa, defaultPower: 5, tags: [BlockTag.UNABLE_TO_ATTACK] },
...
export const SHOP_ITEM_POOL: ShopItem[] = [
  ...
  blockItem(BlockType.PRESSURE_STONE, 40, 0),
  blockItem(BlockType.MINE, 10, 10),
  blockItem(BlockType.GUARDIAN, 40, 5),
  blockItem(BlockType.PORTAL, 40, 7),
